...
void LCD_PWRON (void)
{
	LL_GPIO_WriteHigh(LCDPwrPort, LCDPwrPin);
}
...
{
  LL_GPIO_WriteLow(LCDPwrPort, LCDPwrPin);
}
...
{
  LL_GPIO_WriteHigh(LCDControlPort, LCD_Enable);
  TimingDelay_Decrement(2);
  LL_GPIO_WriteLow(LCDControlPort, LCD_Enable);
}
...
{
  LL_GPIO_WriteLow(LCDControlPort, LCD_RS);
  LL_GPIO_WriteOutputPort(LCDPort, (LL_GPIO_ReadOutputPort(LCDPort) & 0xF0) | ((cmd_data >> 4) & 0x0F));
  LCD_ENABLE();
  LL_GPIO_WriteOutputPort(LCDPort, (LL_GPIO_ReadOutputPort(LCDPort) & 0xF0) | (cmd_data & 0x0F));
  LCD_ENABLE();
  TimingDelay_Decrement(2);
}
...
{
  LL_GPIO_WriteHigh(LCDControlPort, LCD_RS);
  LL_GPIO_WriteOutputPort(LCDPort, (LL_GPIO_ReadOutputPort(LCDPort) & 0xF0) | ((ascode >> 4) & 0x0F));
  LCD_ENABLE();
  LL_GPIO_WriteOutputPort(LCDPort, (LL_GPIO_ReadOutputPort(LCDPort) & 0xF0) | (ascode & 0x0F));
  LCD_ENABLE();
  TimingDelay_Decrement(2);
}
...
{
  unsigned int i, text_size, letter;
